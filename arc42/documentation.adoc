...
application.properties mit H2 für development vorbereitet (Thomas, Anton),
thymeleaf für views angefangen, controller mit SessionScope annotiert, README überschrieben (Anton),
