...
Thymeleaf für Übersicht der Umfragen fertiggestellt und angefangen die Datenbank einzubinden.
Sichten weiterentwickelt: Terminabstimmung, Umfragenabstimmung sind visuell fertig und brauchen jetzt Thymeleaf.
