...
=== (Ingrid, Anton, Thomas)
neue-Termine Formular verbessert,
Übersicht angepasst,
...
==== Details
Wenn termine2/link aufgerufen wird wird entschieden ob die Abstimmungs oder Ergebnisseite Angezeigt wird : 
...
Wenn termine2/link/abstimmung aufgerufen wird gelangt man auf die abstimmungs Seite der Umgrage "link"
...
sicherzustellen, dass ein nNtzer nur eine feste Anzahl 
