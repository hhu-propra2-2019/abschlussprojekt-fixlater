...
hinzugefügt werden können sollen um den Code möglichst allgemein Zu halten)
...
von ihm in der Tabelle stehen. Wenn die AbstimmungsOptionen aber verändert wurden , ergibt es durchaus Sinn, ihn nochmal in der Übersicht anzuzeigen , dass er abstimmen sollte, ohne seine Alten antworten zu löschen (Wenn z.B eine Option hinzugekommen oder eine Gelöscht wurde))